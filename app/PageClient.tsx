  ...
  {/* Your existing <TabsContent> blocks go below */}
        ...
        <TabsContent value="dashboard" className="space-y-4">
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            lines.push("Why: " + (whyTrade || "-"));
            lines.push("Ready: " + (mentalReady || "-"));
            lines.push("Target: " + (sessionTarget || "-"));
            lines.push("Setups: " + (setupsToday || "-"));
            lines.push("");
            lines.push("Start: " + currency(startBalance) + " • Equity: " + currency(equity));
            lines.push("Profit: " + currency(Math.max(0, equity - startBalance)));
            lines.push("Profit-Only threshold: " + String(thresholdPct) + "% (" + currency((thresholdPct / 100) * startBalance) + ")");
            if (givebackPct) { lines.push("Giveback lock (info): " + String(givebackPct) + "%"); }
