  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center">
        <div className="flex items-center justify-end gap-3 mb-4">
          <Link href="/cash" className="rounded-xl border px-3 py-2 hover:shadow">Cashier</Link>
          <Link href="/sign-out" className="rounded-xl bg-gray-900 text-white px-3 py-2 hover:opacity-90">Sign out</Link>
        </div>

        <div className="mb-4"><CashCard /></div>
              ...
              <CardContent className="p-5 space-y-3">
                ...
                <div className="grid md:grid-cols-3 gap-3 items-end">
                  ...
                  <div className="md:col-span-1">
                    ...
                    <Select value={String(lockOnHit)} onValueChange={(v: any) => setLockOnHit(v === "true")}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
        ...
        <div className="space-y-3">
          {rows.map((r, idx) => (
            ...
            >
              ...
              <div className="md:col-span-3">
                <Label>Market</Label>
                <Select value={r.market} onValueChange={(v: any) => updateRow(r.id, { market: v })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="md:col-span-5">
                ...
                <Select value={r.strategy} onValueChange={(v: any) => updateRow(r.id, { strategy: v })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
    ...
    <Card>
      <CardContent className="p-4 space-y-3">
        ...
        <div className="grid md:grid-cols-3 gap-3">
          <div>
            <Label>Setup</Label>
            <Select value={setup} onValueChange={(v: any) => setSetup(v)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
